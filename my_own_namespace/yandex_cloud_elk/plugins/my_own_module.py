...
DOCUMENTATION = r'''
---
module: my_test_senibratov

short_description: This is my test module Senibratova

# If this is part of a collection, you need to use semantic versioning,
# i.e. the version is of the form "2.5.0" and not "2.4".
version_added: "1.0.0"

description: This is my longer description explaining my test module "1.0.0".
...
author:
    - Vyacheslav Senibratov (@nlotomsk)
'''
